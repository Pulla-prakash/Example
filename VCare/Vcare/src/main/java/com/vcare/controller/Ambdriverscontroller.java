...
//		}
	...
	@GetMapping("/selectambulancedriver/{hbrnachId}")
	public String getbyid(Model model,AmbulanceDriverAssosiation ambulancedriverob, @PathVariable("hbrnachId") int hbrnachId) {
		List<AmbulanceDriverAssosiation> AmbdriverList = ambdriversrepository.ambdriverList(hbrnachId);
		model.addAttribute("ambdriverlist", AmbdriverList);
