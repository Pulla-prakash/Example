...
public class EmployeesController {
	...
	public String addEmployee(Model model, @RequestParam("file") MultipartFile file,
			@ModelAttribute(value = "employeeObj") Employees objEmployee,
		...
		String EmployeeObj = employeeService.validateduplicate(objEmployee.getEmail());
		if (EmployeeObj == null) {
			...
			employeeService.saveEmployees(file, objEmployee);
