...
public class PatientsController {
	...
	public String saveRegistration(Model model, @ModelAttribute(value = "patientObj") Patients patientObj) {
	...
	public String loginValidation(Model model, @ModelAttribute(value = "patientObj") Patients patientObj,
		...
		log.info(signinObj.getPatientMailId());
...
//        +"http://localhost:8082/confirm-account?token="+confirmationToken.getConfirmationToken());
	...
	@PostMapping("/patientupload/{hbid}/{did}")
	public String uploadPatient(Model model, Patients patientObj,@RequestParam("slot") String slot,@RequestParam("consultantType") String consultantType,@RequestParam("date") String date,
